...
import { Home, UtensilsCrossed, CalendarDays, Settings } from 'lucide-react';
...
export default function MobileBottomBar() {
  ...
  const NAV_ITEMS = [
    ...
    { label: t('reservar'), href: '/#reservas', icon: CalendarDays },
    { label: t('admin'), href: '/admin', icon: Settings },
  ] as const;
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-crema-light/90 backdrop-blur-md border-t border-border"
